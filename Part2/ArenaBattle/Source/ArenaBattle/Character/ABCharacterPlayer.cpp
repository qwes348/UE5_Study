...
{
	UABCharacterControlData* NewChacterControl = CharacterControlManager[NewCharacterControlType];
	check(NewChacterControl);

	SetCharacterControlData(NewChacterControl);

	APlayerController* PlayerController = CastChecked<APlayerController>(GetController());
	if (UEnhancedInputLocalPlayerSubsystem* Subsystem = ULocalPlayer::GetSubsystem<UEnhancedInputLocalPlayerSubsystem>(PlayerController->GetLocalPlayer()))
	{
		Subsystem->ClearAllMappings();
		UInputMappingContext* NewMappingContext = NewChacterControl->InputMappingContext;
...
void AABCharacterPlayer::SetCharacterControlData(const UABCharacterControlData* CharacterControlData)
{
	...
	CameraBoom->SetRelativeRotation(CharacterControlData->ReleativeRotation);
