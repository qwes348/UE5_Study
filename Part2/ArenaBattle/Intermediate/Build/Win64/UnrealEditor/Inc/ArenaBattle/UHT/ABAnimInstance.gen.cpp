...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UABAnimInstance_Statics::NewProp_MovingThreshold_MetaData[] = {
		{ "Category", "Character" },
		{ "ModuleRelativePath", "Animation/ABAnimInstance.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UABAnimInstance_Statics::NewProp_MovingThreshold = { "MovingThreshold", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UABAnimInstance, MovingThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UABAnimInstance_Statics::NewProp_MovingThreshold_MetaData), Z_Construct_UClass_UABAnimInstance_Statics::NewProp_MovingThreshold_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UABAnimInstance_Statics::NewProp_JumpingThreshold_MetaData[] = {
		{ "Category", "Character" },
		{ "ModuleRelativePath", "Animation/ABAnimInstance.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UABAnimInstance_Statics::NewProp_JumpingThreshold = { "JumpingThreshold", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UABAnimInstance, JumpingThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UABAnimInstance_Statics::NewProp_JumpingThreshold_MetaData), Z_Construct_UClass_UABAnimInstance_Statics::NewProp_JumpingThreshold_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_UE5_Inflearn_Part2_ArenaBattle_Source_ArenaBattle_Animation_ABAnimInstance_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_Inflearn_Part2_ArenaBattle_Source_ArenaBattle_Animation_ABAnimInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UABAnimInstance, UABAnimInstance::StaticClass, TEXT("UABAnimInstance"), &Z_Registration_Info_UClass_UABAnimInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UABAnimInstance), 455508324U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_Inflearn_Part2_ArenaBattle_Source_ArenaBattle_Animation_ABAnimInstance_h_3417768767(TEXT("/Script/ArenaBattle"),
		Z_CompiledInDeferFile_FID_UE5_Inflearn_Part2_ArenaBattle_Source_ArenaBattle_Animation_ABAnimInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE5_Inflearn_Part2_ArenaBattle_Source_ArenaBattle_Animation_ABAnimInstance_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
