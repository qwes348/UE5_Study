...
#include "UnrealBuildSystem/Student.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeStudent() {}
// Cross Module References
	COMMONUTILITY_API UClass* Z_Construct_UClass_UPerson();
	UNREALBUILDSYSTEM_API UClass* Z_Construct_UClass_UStudent();
	UNREALBUILDSYSTEM_API UClass* Z_Construct_UClass_UStudent_NoRegister();
	UPackage* Z_Construct_UPackage__Script_UnrealBuildSystem();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_UStudent_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_UnrealBuildSystem,
	};
	...
	template<> UNREALBUILDSYSTEM_API UClass* StaticClass<UStudent>()
	{
		return UStudent::StaticClass();
	}
	...
	UStudent::~UStudent() {}
	struct Z_CompiledInDeferFile_FID_UE5_Inflearn_Part1_UnrealBuildSystem_Source_UnrealBuildSystem_Student_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_Inflearn_Part1_UnrealBuildSystem_Source_UnrealBuildSystem_Student_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStudent, UStudent::StaticClass, TEXT("UStudent"), &Z_Registration_Info_UClass_UStudent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStudent), 673179497U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_Inflearn_Part1_UnrealBuildSystem_Source_UnrealBuildSystem_Student_h_1279212159(TEXT("/Script/UnrealBuildSystem"),
		Z_CompiledInDeferFile_FID_UE5_Inflearn_Part1_UnrealBuildSystem_Source_UnrealBuildSystem_Student_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE5_Inflearn_Part1_UnrealBuildSystem_Source_UnrealBuildSystem_Student_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
